...
public class IntelligentTrailingStopConfigParams extends IntelligentTradeTracker {
    ...
    public IntelligentTrailingStopConfigParams(BigDecimal gainNeeded, BigDecimal belowBE, BigDecimal aboveBE, BigDecimal minAboveBE, int lookback, int lookingForUpMovement) {
        super();
